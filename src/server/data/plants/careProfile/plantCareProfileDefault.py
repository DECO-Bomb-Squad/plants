from data.constants import TBL_PLANT_CARE_PROFILE_DEFAULT, TBL_PLANTS
...
class PlantCareProfileDefault(DB.BASE):
    ...
    plantTypeId = Column("plantTypeId", Integer, ForeignKey(f"{TBL_PLANTS}.id", name=f"fk_plant_id_{__tablename__}"), nullable=False)
