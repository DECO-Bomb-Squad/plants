...
class _PlantAddScreenState extends State<PlantAddScreen> {
  ...
  Future<List<PlantTypeModel>> get typeList async => types = await widget.api.getPlantTypes();
                                    ...
                                    SizedBox(
                                      ...
                                      suggestionsCallback: (pattern) {
                                        return types.where((element) =>
                                            element.commonName.contains(pattern) || element.fullName.contains(pattern));
                                      },
