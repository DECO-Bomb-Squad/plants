                    ...
                    child: Column(
                        ...
                        children: [
                          ElevatedButton(
                              ...
                              onPressed: (() {
                                showDialog(
                                    context: context, builder: (_) => SelectPlantDialog(getUserPlants, putUserPlants));
                              }),
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.center,
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: const [Text("Attach plants", style: buttonTextStyle)],
                              ))
                        ])),
                SizedBox(
                  ...
                  children: [
                    ElevatedButton(
                      onPressed: () {
                        ...
                        GetIt.I<PlantAPI>().addPost(PostInfoModel(
                            GetIt.I<PlantAPI>().user!.id,
                            GetIt.I<PlantAPI>().user!.username,
                            titleController.text,
                            textController.text,
                            userPlants.keys.toList()));
